export const WQuestionsL3 = [
    {
        type: "singleChoice",
        question: "Wieviel Kilogramm CO2 verursacht die Herstellung eines T-Shirts je nach Größe?",
        answers: [
            { text: "5-9 Kilogramm CO2", correct: true },
    ...
    {
        type: "singleChoice",
        question: "Wieviel Prozent trägt dein täglicher Konsum ca. zu deinem jährlichen Pro-Kopf-CO2-Ausstoß bei?",
        answers: [
    ...
    {
        type: "singleChoice",
        question: "Wieviel Kilogramm CO2 verursacht ein Deutscher durchschnittlich pro Jahr durch den Kauf von Kleidung und Textilien?",
        answers: [
            { text: "100 Kilogramm CO2", correct: false },
    ...
    {
        type: "singleChoice",
        question: "Was ist KEIN Grund für den Beitrag des globalen Plastikkonsums am Klimawandel?",
        answers: [
            { text: "Von der Produktion bis zur Entsorgung von Plastik wird viel CO2 ausgestoßen.", correct: false },
