...
export const energieFragenA5 = [
    {
        ...
        answers:[
            {text: "Wenn man über das Smartphone oder das Tablet streamt, anstatt über den großen Fernseher, verbraucht man nur ein Sechstel des Stroms.", correct: "correct"},
            {text: "Statt einen Film zu streamen, kaufe ich lieber eine DVD.", correct: "wrong"},
            {text: "Ich streame Videos in reduzierter Auflösung nutze das WLAN anstatt mobile Daten.", correct: "ok"}
            ],
